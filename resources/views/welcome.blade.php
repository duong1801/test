        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <h1 style="font-size: 65px;font-weight: bold">Xhamter</h1>
                </div>
                ...
                <div class="flex justify-center mt-16 px-0 ">
                   <h2>Deploy Laravel Application Using Docker By
                       <a style="color: blue" href="https://www.facebook.com/profile.php?id=100009598371002">Quang Nguyễn</a>
                   </h2>
                </div>
            </div>
        </div>
